...
| Master01 | 192.168.3.161 | master节点 | kube-apiserver、kube-controller-manager、kube-scheduler、etcd、<br />kubelet、kube-proxy、nfs-client、haproxy、keepalived、nginx |
| Master02 | 192.168.3.162 | master节点 | kube-apiserver、kube-controller-manager、kube-scheduler、etcd、<br />kubelet、kube-proxy、nfs-client、haproxy、keepalived、nginx |
| Master03 | 192.168.3.163 | master节点 | kube-apiserver、kube-controller-manager、kube-scheduler、etcd、<br />kubelet、kube-proxy、nfs-client、haproxy、keepalived、nginx |
| Node01   | 192.168.3.164 | node节点   | kubelet、kube-proxy、nfs-client、nginx                                                                                     |
| Node02   | 192.168.3.165 | node节点   | kubelet、kube-proxy、nfs-client、nginx                                                                                     |
|          | 192.168.3.160 | VIP      |                                                                                                                         |
...
ssh root@192.168.3.161 "rm -rf /etc/machine-id; systemd-machine-id-setup;reboot"
ssh root@192.168.3.162 "rm -rf /etc/machine-id; systemd-machine-id-setup;reboot"
ssh root@192.168.3.163 "rm -rf /etc/machine-id; systemd-machine-id-setup;reboot"
ssh root@192.168.3.164 "rm -rf /etc/machine-id; systemd-machine-id-setup;reboot"
ssh root@192.168.3.165 "rm -rf /etc/machine-id; systemd-machine-id-setup;reboot"
# 
# 查看当前的网卡列表和 UUID：
# nmcli con show
# 删除要更改 UUID 的网络连接：
...
ssh root@192.168.3.161 "nmcli con delete uuid d1141403-18c6-3149-907c-ed5f09663a7f;nmcli con add type ethernet ifname ens160 con-name ens160;nmcli con up ens160"
ssh root@192.168.3.162 "nmcli con delete uuid d1141403-18c6-3149-907c-ed5f09663a7f;nmcli con add type ethernet ifname ens160 con-name ens160;nmcli con up ens160"
ssh root@192.168.3.163 "nmcli con delete uuid d1141403-18c6-3149-907c-ed5f09663a7f;nmcli con add type ethernet ifname ens160 con-name ens160;nmcli con up ens160"
ssh root@192.168.3.164 "nmcli con delete uuid d1141403-18c6-3149-907c-ed5f09663a7f;nmcli con add type ethernet ifname ens160 con-name ens160;nmcli con up ens160"
ssh root@192.168.3.165 "nmcli con delete uuid d1141403-18c6-3149-907c-ed5f09663a7f;nmcli con add type ethernet ifname ens160 con-name ens160;nmcli con up ens160"

# 参数解释
# 
# ssh ssh root@192.168.3.161
# 使用SSH登录到IP为192.168.3.161的主机，使用root用户身份。
# 
...
# 修改静态的IPv4地址
ssh root@192.168.3.161 "nmcli con mod ens160 ipv4.addresses 192.168.3.161/24; nmcli con mod ens160 ipv4.gateway  192.168.1.1; nmcli con mod ens160 ipv4.method manual; nmcli con mod ens160 ipv4.dns "8.8.8.8"; nmcli con up ens160"
ssh root@192.168.3.162 "nmcli con mod ens160 ipv4.addresses 192.168.3.162/24; nmcli con mod ens160 ipv4.gateway  192.168.1.1; nmcli con mod ens160 ipv4.method manual; nmcli con mod ens160 ipv4.dns "8.8.8.8"; nmcli con up ens160"
ssh root@192.168.3.163 "nmcli con mod ens160 ipv4.addresses 192.168.3.163/24; nmcli con mod ens160 ipv4.gateway  192.168.1.1; nmcli con mod ens160 ipv4.method manual; nmcli con mod ens160 ipv4.dns "8.8.8.8"; nmcli con up ens160"
ssh root@192.168.3.164 "nmcli con mod ens160 ipv4.addresses 192.168.3.164/24; nmcli con mod ens160 ipv4.gateway  192.168.1.1; nmcli con mod ens160 ipv4.method manual; nmcli con mod ens160 ipv4.dns "8.8.8.8"; nmcli con up ens160"
ssh root@192.168.3.165 "nmcli con mod ens160 ipv4.addresses 192.168.3.165/24; nmcli con mod ens160 ipv4.gateway  192.168.1.1; nmcli con mod ens160 ipv4.method manual; nmcli con mod ens160 ipv4.dns "8.8.8.8"; nmcli con up ens160"
...
# 
# "nmcli con mod ens160 ipv4.addresses 192.168.3.161/24"
# 修改ens160网络连接的IPv4地址为192.168.3.161，子网掩码为 24。
# 
...
ssh root@192.168.3.161 "nmcli con mod ens160 ipv6.addresses fc00::31/8; nmcli con up ens160"
ssh root@192.168.3.162 "nmcli con mod ens160 ipv6.addresses fc00::32/8; nmcli con up ens160"
ssh root@192.168.3.163 "nmcli con mod ens160 ipv6.addresses fc00::33/8; nmcli con up ens160"
ssh root@192.168.3.164 "nmcli con mod ens160 ipv6.addresses fc00::34/8; nmcli con up ens160"
ssh root@192.168.3.165 "nmcli con mod ens160 ipv6.addresses fc00::35/8; nmcli con up ens160"

# IPv6地址路由DNS，样例
ssh root@192.168.3.161 "nmcli con mod ens160 ipv6.addresses fc00:43f4:1eea:1::10; nmcli con mod ens160 ipv6.gateway fc00:43f4:1eea:1::1; nmcli con mod ens160 ipv6.method manual; nmcli con mod ens160 ipv6.dns "2400:3200::1"; nmcli con up ens160"
ssh root@192.168.3.162 "nmcli con mod ens160 ipv6.addresses fc00:43f4:1eea:1::20; nmcli con mod ens160 ipv6.gateway fc00:43f4:1eea:1::1; nmcli con mod ens160 ipv6.method manual; nmcli con mod ens160 ipv6.dns "2400:3200::1"; nmcli con up ens160"
ssh root@192.168.3.163 "nmcli con mod ens160 ipv6.addresses fc00:43f4:1eea:1::30; nmcli con mod ens160 ipv6.gateway fc00:43f4:1eea:1::1; nmcli con mod ens160 ipv6.method manual; nmcli con mod ens160 ipv6.dns "2400:3200::1"; nmcli con up ens160"
ssh root@192.168.3.164 "nmcli con mod ens160 ipv6.addresses fc00:43f4:1eea:1::40; nmcli con mod ens160 ipv6.gateway fc00:43f4:1eea:1::1; nmcli con mod ens160 ipv6.method manual; nmcli con mod ens160 ipv6.dns "2400:3200::1"; nmcli con up ens160"
ssh root@192.168.3.165 "nmcli con mod ens160 ipv6.addresses fc00:43f4:1eea:1::50; nmcli con mod ens160 ipv6.gateway fc00:43f4:1eea:1::1; nmcli con mod ens160 ipv6.method manual; nmcli con mod ens160 ipv6.dns "2400:3200::1"; nmcli con up ens160"

# 参数解释
# 
# ssh root@192.168.3.161
# 通过SSH连接到IP地址为192.168.3.161的远程主机，使用root用户进行登录。
# 
...
[ipv4]
address1=192.168.3.161/24,192.168.1.1
dns=192.168.1.99;
method=manual
...
# 3. `[ipv4]`:
#    - `address1`: 以CIDR表示法指定IPv4地址和子网掩码（`192.168.3.161/24`）。还包括网关IP（`192.168.1.1`）。
...
# 拷贝包到内网机器上
scp -r /data/centos7/ root@192.168.3.161:
scp -r /data/centos7/ root@192.168.3.162:
scp -r /data/centos7/ root@192.168.3.163:
scp -r /data/centos7/ root@192.168.3.164:
scp -r /data/centos7/ root@192.168.3.165:
...
# 拷贝包到内网机器上
scp -r centos8/ root@192.168.3.161:
scp -r centos8/ root@192.168.3.162:
scp -r centos8/ root@192.168.3.163:
scp -r centos8/ root@192.168.3.164:
scp -r centos8/ root@192.168.3.165:
...
# 拷贝包到内网机器上
scp -r centos9/ root@192.168.3.161:
scp -r centos9/ root@192.168.3.162:
scp -r centos9/ root@192.168.3.163:
scp -r centos9/ root@192.168.3.164:
scp -r centos9/ root@192.168.3.165:
...
# 拷贝包到内网机器上
scp -r ubuntu/ root@192.168.3.161:
scp -r ubuntu/ root@192.168.3.162:
scp -r ubuntu/ root@192.168.3.163:
scp -r ubuntu/ root@192.168.3.164:
scp -r ubuntu/ root@192.168.3.165:
...
export IP="192.168.3.161 192.168.3.162 192.168.3.163 192.168.3.164 192.168.3.165"
...
# 
# 3. `export IP="192.168.3.161 192.168.3.162 192.168.3.163 192.168.3.164 192.168.3.165"`：设置一个包含多个远程主机IP地址的环境变量IP，用空格分隔开，表示要将SSH公钥复制到这些远程主机上。
# 
...
[root@localhost opt]# cd kernel-lt-5.4.278/
[root@localhost kernel-lt-5.4.278]# tree
.
...
[root@localhost kernel-lt-5.4.278]# yum localinstall -y kernel-lt-*.rpm

 (3/3): epel/x86_64/primary_db | 8.7 MB 00:00:05 No package matched to upgrade: kernel-lt-headers --> Processing Conflict: kernel-lt-tools-libs-5.4.278-1.el7.elrepo.x86_64 conflicts kernel-tools-libs < 5.4.278-1.el7.elrepo --> Restarting Dependency Resolution with new changes. --> Running transaction check ---> Package kernel-tools-libs.x86_64 0:3.10.0-1127.el7 will be updated --> Processing Dependency: kernel-tools-libs = 3.10.0-1127.el7 for package: kernel-tools-3.10.0-1127.el7.x86_64 ---> Package kernel-tools-libs.x86_64 0:3.10.0-1160.119.1.el7 will be an update --> Running transaction check ---> Package kernel-tools.x86_64 0:3.10.0-1127.el7 will be updated ---> Package kernel-tools.x86_64 0:3.10.0-1160.119.1.el7 will be an update --> Processing Conflict: kernel-lt-headers-5.4.278-1.el7.elrepo.x86_64 conflicts kernel-headers < 5.4.278-1.el7.elrepo No package matched to upgrade: kernel-lt-headers --> Processing Conflict: kernel-lt-tools-libs-5.4.278-1.el7.elrepo.x86_64 conflicts kernel-tools-libs < 5.4.278-1.el7.elrepo No package matched to upgrade: kernel-lt-tools-libs --> Processing Conflict: kernel-lt-tools-5.4.278-1.el7.elrepo.x86_64 conflicts kernel-tools < 5.4.278-1.el7.elrepo No package matched to upgrade: kernel-lt-tools --> Finished Dependency Resolution Error: kernel-lt-tools conflicts with kernel-tools-3.10.0-1160.119.1.el7.x86_64 Error: kernel-lt-headers conflicts with kernel-headers-3.10.0-1160.119.1.el7.x86_64 Error: kernel-lt-tools-libs conflicts with kernel-tools-libs-3.10.0-1160.119.1.el7.x86_64 You could try using --skip-broken to work around the problem You could try running: rpm -Va --nofiles --nodigest
...
```shell
echo '
192.168.3.161 k8s-master01
192.168.3.162 k8s-master02
192.168.3.163 k8s-master03
192.168.3.164 k8s-node01
192.168.3.165 k8s-node02
192.168.3.160 lb-vip
...
scp docker/* root@k8s-master01:/usr/bin/
scp docker/* root@k8s-master02:/usr/bin/
scp docker/* root@k8s-master03:/usr/bin/
scp docker/* root@k8s-node01:/usr/bin/
scp docker/* root@k8s-node02:/usr/bin/
```
...
echo '{
  ...
  "proxies": {
    "http-proxy": "http://192.168.3.100:10809",
    "https-proxy": "http://192.168.3.100:10809",
    "no-proxy": "localhost"
  }
}
...
scp cri-dockerd/* root@k8s-master01:/usr/bin/
scp cri-dockerd/* root@k8s-master02:/usr/bin/
scp cri-dockerd/* root@k8s-master03:/usr/bin/
scp cri-dockerd/* root@k8s-node01:/usr/bin/
scp cri-dockerd/* root@k8s-node02:/usr/bin/
```
...
[Service]
Type=notify
ExecStart=/usr/bin/cri-dockerd --network-plugin=cni --pod-infra-container-image=docker.io/rancher/pause:3.6
ExecReload=/bin/kill -s HUP $MAINPID
TimeoutSec=0
RestartSec=5
Restart=always
...
cfssl gencert \
   ...
   -hostname=127.0.0.1,k8s-master01,k8s-master02,k8s-master03,192.168.3.161,192.168.3.162,192.168.3.163,::1 \
   -profile=kubernetes \
...
# 10.96.0.1是service网段的第一个地址，需要计算，192.168.3.161为高可用vip地址
# 若没有IPv6 可删除可保留 
...
# - `-hostname=10.96.0.1,192.168.3.161,127.0.0.1,fc00:43f4:1eea:1::10`：指定证书的主机名或IP地址列表。
...
若使用 haproxy、keepalived 那么为 `--server=https://192.168.3.161:9443`
...
listen-peer-urls: 'https://192.168.3.161:2380'
listen-client-urls: 'https://192.168.3.161:2379,http://127.0.0.1:2379'
max-snapshots: 3
max-wals: 5
cors:
initial-advertise-peer-urls: 'https://192.168.3.161:2380'
advertise-client-urls: 'https://192.168.3.161:2379'
discovery:
discovery-fallback: 'proxy'
discovery-proxy:
discovery-srv:
initial-cluster: 'k8s-master01=https://192.168.3.161:2380,k8s-master02=https://192.168.3.162:2380,k8s-master03=https://192.168.3.163:2380'
...
listen-client-urls: 'https://192.168.3.162:2379,http://127.0.0.1:2379'
max-snapshots: 3
max-wals: 5
cors:
...
election-timeout: 1000
quota-backend-bytes: 0
listen-peer-urls: 'https://192.168.3.163:2380'
listen-client-urls: 'https://192.168.3.163:2379,http://127.0.0.1:2379'
max-snapshots: 3
max-wals: 5
cors:
initial-advertise-peer-urls: 'https://192.168.3.163:2380'
advertise-client-urls: 'https://192.168.3.163:2379'
discovery:
discovery-fallback: 'proxy'
discovery-proxy:
discovery-srv:
...
etcdctl --endpoints="192.168.3.163:2379,192.168.3.162:2379,192.168.3.161:2379" --cacert=/etc/kubernetes/pki/etcd/etcd-ca.pem --cert=/etc/kubernetes/pki/etcd/etcd.pem --key=/etc/kubernetes/pki/etcd/etcd-key.pem  endpoint status --write-out=table
+-------------------+------------------+---------+-----------------+---------+--------+-----------------------+--------+-----------+------------+-----------+------------+--------------------+--------+--------------------------+-------------------+
|     ENDPOINT      |        ID        | VERSION | STORAGE VERSION | DB SIZE | IN USE | PERCENTAGE NOT IN USE | QUOTA  | IS LEADER | IS LEARNER | RAFT TERM | RAFT INDEX | RAFT APPLIED INDEX | ERRORS | DOWNGRADE TARGET VERSION | DOWNGRADE ENABLED |
+-------------------+------------------+---------+-----------------+---------+--------+-----------------------+--------+-----------+------------+-----------+------------+--------------------+--------+--------------------------+-------------------+
| 192.168.3.163:2379 |  8065f2e59c8d68c |   3.6.7 |           3.6.0 |   20 kB |  16 kB |                   20% | 2.1 GB |     false |      false |         4 |         14 |                 14 |        |                          |             false |
| 192.168.3.162:2379 | b7b7ad6bf4db3f28 |   3.6.7 |           3.6.0 |   20 kB |  16 kB |                   20% | 2.1 GB |      true |      false |         4 |         14 |                 14 |        |                          |             false |
| 192.168.3.161:2379 | bf047bcfe3b9bf27 |   3.6.7 |           3.6.0 |   20 kB |  16 kB |                   20% | 2.1 GB |     false |      false |         4 |         14 |                 14 |        |                          |             false |
+-------------------+------------------+---------+-----------------+---------+--------+-----------------------+--------+-----------+------------+-----------+------------+--------------------+--------+--------------------------+-------------------+
...
# 
# - `--endpoints`：指定要连接的etcd集群节点的地址和端口。在这个例子中，指定了3个节点的地址和端口，分别是`192.168.3.163:2379,192.168.3.162:2379,192.168.3.161:2379`。
...
stream {
    upstream backend {
        ...
        server 192.168.3.161:6443        max_fails=3 fail_timeout=30s;
        server 192.168.3.162:6443        max_fails=3 fail_timeout=30s;
        server 192.168.3.163:6443        max_fails=3 fail_timeout=30s;
    }
    server {
...
backend k8s-master
 ...
 server  k8s-master01  192.168.3.161:6443 check
 server  k8s-master02  192.168.3.162:6443 check
 server  k8s-master03  192.168.3.163:6443 check
EOF
```
...
5. backend k8s-master:
   ...
   - server k8s-master01 192.168.3.161:6443 check: 增加一个名为k8s-master01的服务器，IP地址为192.168.3.161，端口号为6443，并对其进行健康检查。
   - server k8s-master02 192.168.3.162:6443 check: 增加一个名为k8s-master02的服务器，IP地址为192.168.3.162，端口号为6443，并对其进行健康检查。
   - server k8s-master03 192.168.3.163:6443 check: 增加一个名为k8s-master03的服务器，IP地址为192.168.3.163，端口号为6443，并对其进行健康检查。
...
- `vrrp_instance`部分定义了一个VRRP实例。`VI_1`是实例的名称。
    ...
    - `mcast_src_ip`参数指定了VRRP报文的源IP地址，这里设置为192.168.3.161。
    ...
    - `virtual_ipaddress`部分指定了虚拟IP地址，这里设置为192.168.3.161。
...
```shell
# 能ping同
[root@k8s-node02 ~]# ping 192.168.3.161

# 能telnet访问
[root@k8s-node02 ~]# telnet 192.168.3.161 9443
...
ExecStart=/usr/local/bin/kube-apiserver \\
      ...
      --secure-port=6443  \\
      --advertise-address=192.168.3.161 \\
      --service-cluster-ip-range=10.96.0.0/12,fd00:1111::/112  \\
      --service-node-port-range=30000-32767  \\
      --etcd-servers=https://192.168.3.161:2379,https://192.168.3.162:2379,https://192.168.3.163:2379 \\
...
ExecStart=/usr/local/bin/kube-apiserver \\
      ...
      --bind-address=0.0.0.0  \\
      --secure-port=6443  \\
      --advertise-address=192.168.3.162 \\
      --service-cluster-ip-range=10.96.0.0/12,fd00:1111::/112  \\
      --service-node-port-range=30000-32767  \\
      --etcd-servers=https://192.168.3.161:2379,https://192.168.3.162:2379,https://192.168.3.163:2379 \\
      --etcd-cafile=/etc/etcd/ssl/etcd-ca.pem  \\
...
ExecStart=/usr/local/bin/kube-apiserver \\
      ...
      --bind-address=0.0.0.0  \\
      --secure-port=6443  \\
      --advertise-address=192.168.3.163 \\
      --service-cluster-ip-range=10.96.0.0/12,fd00:1111::/112  \\
      --service-node-port-range=30000-32767  \\
      --etcd-servers=https://192.168.3.161:2379,https://192.168.3.162:2379,https://192.168.3.163:2379 \\
      --etcd-cafile=/etc/etcd/ssl/etcd-ca.pem  \\
...
- `--advertise-address=192.168.3.161` 广告API Server的地址。
- `--service-cluster-ip-range=10.96.0.0/12,fd00:1111::/112` 指定服务CIDR范围。
- `--service-node-port-range=30000-32767` 指定NodePort的范围。
- `--etcd-servers=https://192.168.3.161:2379,https://192.168.3.162:2379,https://192.168.3.163:2379` 指定etcd服务器的地址。
...
```shell
http://192.168.3.161:32648
http://192.168.3.161:30495
http://192.168.3.161:31568
```
...
calico-node-97m55                          1/1     Running   0          38m     192.168.3.164     k8s-node01     <none>           <none>
calico-node-hlz7j                          1/1     Running   0          38m     192.168.3.162     k8s-master02   <none>           <none>
calico-node-jtlck                          1/1     Running   0          38m     192.168.3.163     k8s-master03   <none>           <none>
calico-node-lxfkf                          1/1     Running   0          38m     192.168.3.165     k8s-node02     <none>           <none>
calico-node-t667x                          1/1     Running   0          38m     192.168.3.161     k8s-master01   <none>           <none>
calico-typha-59d75c5dd4-gbhfp              1/1     Running   0          38m     192.168.3.165     k8s-node02     <none>           <none>
...
/ # ping 192.168.3.164
PING 192.168.3.164 (192.168.3.164): 56 data bytes
64 bytes from 192.168.3.164: seq=0 ttl=63 time=0.358 ms
64 bytes from 192.168.3.164: seq=1 ttl=63 time=0.668 ms
64 bytes from 192.168.3.164: seq=2 ttl=63 time=0.637 ms
64 bytes from 192.168.3.164: seq=3 ttl=63 time=0.624 ms
64 bytes from 192.168.3.164: seq=4 ttl=63 time=0.907 ms
...
# 使用IPv4地址访问测试
[root@k8s-master01 ~]# curl -I http://192.168.3.161:32651
HTTP/1.1 200 OK
Server: nginx/1.29.1
