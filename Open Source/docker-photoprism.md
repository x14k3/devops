...
      PHOTOPRISM_ADMIN_PASSWORD: "xxxxxxxx"          # INITIAL PASSWORD FOR "admin" USER, MINIMUM 8 CHARACTERS
...
      - "/data/application/photoprism/originals:/photoprism/originals"            # Original media files (DO NOT REMOVE)
      - "/data/application/photoprism/import:/photoprism/import"                  # *Optional* base folder from which files can be imported to originals
      - "/data/application/photoprism/storage:/photoprism/storage"                # *Writable* storage folder for cache, database, and sidecar files (DO NOT REMOVE)
...
    volumes:
      - "/data/application/photoprism/mariadb:/var/lib/mysql" # DO NOT REMOVE
    environment:
