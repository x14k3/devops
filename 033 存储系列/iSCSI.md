...
### <span id="20231110105237-zjlcoms" style="display: none;"></span>**第四步：设置访问控制列表（ACL）**
...
参考[第四步：设置访问控制列表（ACL）](#20231110105237-zjlcoms)增加一个ACL，使得oracle-rac1和oracle-rac2使用不同的ACL即可
