...
| -------- | --------------- | --------------- | --------------- | --------------- |
| rac-01   | 192.168.133.201 | 172.168.133.201 | 192.168.133.211 | 192.168.133.222 |
...
#rlwrap.rpm 下载地址:https://dl.fedoraproject.org/pub/archive/epel/7/x86_64/Packages/r/
...
# 分别在ora19c-rac1和ora19c-rac2以root用户执行 这里节点有先后顺序，rac-01节点运行两个脚本，然后rac-02再运行
