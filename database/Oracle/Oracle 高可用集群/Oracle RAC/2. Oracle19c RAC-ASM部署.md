...
| -------- | --------------- | --------------- | --------------- | ----------------------- |
| rac-01   | 192.168.133.201 | 172.168.133.201 | 192.168.133.211 | 192.168.133.221/222/223 |
| rac-02   | 192.168.133.202 | 172.168.133.202 | 192.168.133.212 |                         |
| rac-data | 192.168.133.203 |                 |                 |                         |
...
192.168.133.203 rac-data

#pri-ip
172.168.133.201  rac-01-priv
172.168.133.201  rac-02-priv
...
#scan-ip,use dns
#192.168.133.221 rac01.scan.com
#192.168.133.222 rac01.scan.com
#192.168.133.223 rac01.scan.com
EOF

## 设置dns服务
echo "nameserver 192.168.133.203" >> /etc/resolv.conf
...
oracle.install.crs.config.clusterNodes=rac-01:rac-01-vip:192.168.10.211,rac-02:rac-02-vip:192.168.10.212 \
oracle.install.crs.config.networkInterfaceList=ens192:192.168.10.0:1,ens192:172.168.10.0:5 \
...
# `-nowait`: 不等待安装完成，立即返回（通常用于后台运行，不推荐，因为无法及时知道安装结果）。
