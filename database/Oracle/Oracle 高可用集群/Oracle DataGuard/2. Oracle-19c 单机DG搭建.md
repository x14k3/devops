...
[静默安装 Oracle19c](静默安装%20Oracle19c.md)
...
[Oracle之redo log 管理](Oracle之redo%20log%20管理.md)
...
步骤参考：[基于RMAN实现异机恢复](基于RMAN实现异机恢复.md)
...
![](net-img-Image-10.2.1-20230817174529-hg943gi.gif)
