...
![bolg_sd_mutil_cluster](assets/bolg_sd_mutil_cluster-20230802153347-zs3j1g4.png "基于Consul的服务发现")​
...
![prometheus_file_target_metadata](assets/prometheus_file_target_metadata-20230802153402-llyrjbi.png "实例的Metadata信息")​
...
![when-relabel-work](assets/when-relabel-work-20230802153417-qy2v6mp.png "Relabeling作用时机")​
...
![relabel_hash_mode](assets/relabel_hash_mode-20230802153436-roe2bg7.png "计算Hash值")​
