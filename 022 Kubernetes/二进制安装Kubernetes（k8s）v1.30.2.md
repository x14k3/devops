...
　　参考：[https://github.com/cby-chen/Kubernetes](https://github.com/cby-chen/Kubernetes)
...
|Master01|192.168.1.41|master节点|kube-apiserver、kube-controller-manager、kube-scheduler、etcd、kubelet、kube-proxy、nfs-client、haproxy、keepalived、nginx|
|Master02|192.168.1.42|master节点|kube-apiserver、kube-controller-manager、kube-scheduler、etcd、kubelet、kube-proxy、nfs-client、haproxy、keepalived、nginx|
|Master03|192.168.1.43|master节点|kube-apiserver、kube-controller-manager、kube-scheduler、etcd、kubelet、kube-proxy、nfs-client、haproxy、keepalived、nginx|
