...
```sql
CREATE USER 'jy2bpc'@'localhost' IDENTIFIED BY '123456';   #仅限本机登录
CREATE USER 'jy2bpc'@'192.168.1.1' IDENDIFIED BY '123456'; #指定ip远程登录
CREATE USER 'jy2bpc'@'%' IDENTIFIED BY '123456';           #所有电脑可远程登录
-- mysql 8.0
CREATE USER 'jy2bpc'@'%' IDENTIFIED with mysql_native_password by 'Ninestar@2021';
...
grant all privileges on jy2gm.* to jy2gm@'%';
grant all privileges on jy2gm.* to jy2gm@'%' identified by 'Ninestar@2021';
# 刷新权限
flush privileges;
# 删除权限
