...
![](assets/git/image-20221127214224933.png) 
![](assets/git/image-20221201222000199.png)
...
git add .
# 用git commit把项目提交到仓库。-m后面引号里面是本次提交的注释内容，这个可以不写，但最好写上，不然会报错
git commit -m "新增笔记"
# 创建SSH KEY 将id_rsa.pub复制到github的Authentication Keys中
# 在Github上创建一个Git仓库。
