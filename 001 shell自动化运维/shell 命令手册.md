# shell 命令手册
    ...
    at - 在指定时间执行一个任务  
    ((20231110105237-gdmjj78 'awk')) - 文本和数据进行处理的编程语言  
    ...
    cat - 连接多个文件并打印到标准输出。  
    cd - 切换用户当前工作目录。  
    ((20231115125125-izc6y8a "cdrecord")) - Linux系统下光盘刻录功能命令  
    ...
    gpm - 提供文字模式下的滑鼠事件处理  
    ((20231110105237-04wlj04 'grep')) - 强大的文本搜索工具  
    ...
    ppp-off - 关闭ppp连线  
    pr - 将文本文件转换成适合打印的格式  
    ((20231110105237-9b4ud5g "print")) - 格式化并输出结果。  
    ...
    ((20231110105237-autexik 'sed')) - 功能强大的流式文本编辑器  
    ...
    ((20231110105237-btc7aee 'tcpdump')) - 一款sniffer工具，是Linux上的抓包工具，嗅探器  
