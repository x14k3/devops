...
![alertmanager](assets/alertmanager-20230802142921-cw008wx.png)
...
![prometheus-alert-firing-with-manager](assets/prometheus-alert-firing-with-manager-20230802142935-ugq1pc0.png)

查看Alertmanager UI此时可以看到Alertmanager接收到的告警信息。

![alertmanager-alert](assets/alertmanager-alert-20230802142941-1dltqg4.png)
