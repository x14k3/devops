...
![prometheus-ui-alert](prometheus-ui-alert-20230802142718-nnhc3vk.png)
...
![prometheus-ui-rules](prometheus-ui-rules-20230802142730-e18176q.png)
...
![node_cpu_usgae_high](node_cpu_usgae_high-20230802142756-2lguk3h.png)

Prometheus首次检测到满足触发条件后，hostCpuUsageAlert显示由一条告警处于活动状态。由于告警规则中设置了1m的等待时间，当前告警状态为PENDING，如下图所示：

![node_cpu_alert_pending](node_cpu_alert_pending-20230802142803-cggfxjh.png)

如果1分钟后告警条件持续满足，则会实际触发告警并且告警状态为FIRING，如下图所示：

![node_cpu_alert_firing](node_cpu_alert_firing-20230802142813-rzsw22d.png)
