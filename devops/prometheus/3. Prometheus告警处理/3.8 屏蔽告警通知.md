...
​​![alertmanager-new-slicense](alertmanager-new-slicense-20230802144038-taqp3ev.png)​​
...
​​![alertmanager-active-silences](alertmanager-active-silences-20230802144054-mkk1tx4.png)​​

当静默规则生效以后，从Alertmanager的Alerts页面下用户将不会看到该规则匹配到的告警信息。

​​![alertmanager-slicense-alerts-result](alertmanager-slicense-alerts-result-20230802144105-xi95mjt.png)​​
