...
![mail-alert-page](mail-alert-page-20230802143320-odxyq8l.png)
...
![slack-overview](slack-overview-20230802143436-b822a3f.png)

Slack作为一款即时通讯工具，协作沟通主要通过Channel（平台）来完成，用户可以在企业中根据用途添加多个Channel，并且通过Channel来集成各种第三方工具。

例如，我们可以为监控建立一个单独的Channel用于接收各种监控信息：

![slack-create-channel](slack-create-channel-20230802143452-0yubr6v.png)

通过一个独立的Channle可以减少信息对用户工作的干扰，并且将相关信息聚合在一起：

![slack-channel](slack-channel-20230802143505-q0325kt.png)
...
![add-incomming-webhooks](add-incomming-webhooks-20230802143517-1ncqod1.png)

添加成功后Slack会显示`Incoming WebHooks`​配置和使用方式：

![incomming-webhooks-setting](incomming-webhooks-setting-20230802143529-ww4yh2b.png)
...
![slack-receiver-message](slack-receiver-message-20230802143550-iahgaiu.png)
...
![custom-slack-message](custom-slack-message-20230802143602-bcagn05.png)
...
![slack_alert_message](slack_alert_message-20230802143614-5nabpsx.png)

而当告警项恢复正常后，则可以接收到如下通知：

![slack_resolved_message](slack_resolved_message-20230802143622-yuh65bz.png)
...
![wechat-alert-page](wechat-alert-page-20230802143724-w2spqtn.png)
...
![dingding-group-robot](dingding-group-robot-20230802143832-k9znmk0.png)

选择“自定义机器人”，并且按照提示填写机器人名称，获取机器人webhook地址，如下所示：

![dingtalk-robot-create-webhook](dingtalk-robot-create-webhook-20230802143842-ofma4eq.png)
...
![dingtalk-message-test](dingtalk-message-test-20230802143852-9v1lqur.png)
...
![alertmanager-dingtalk-test-result](alertmanager-dingtalk-test-result-20230802143908-twd1kwi.png)
