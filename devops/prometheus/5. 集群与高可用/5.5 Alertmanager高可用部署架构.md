...
![prom-ha-with-single-am](assets/prom-ha-with-single-am-20230802152506-n7lirt9.png "Alertmanager成为单点")​
...
![alertmanager-features](assets/alertmanager-features-20230802142423-q4af7yv.png "Alertmanager特性")​
...
![prom-ha-with-double-am](assets/prom-ha-with-double-am-20230802152540-bvn9x8t.png)
...
![prom-ha-with-am-gossip](assets/prom-ha-with-am-gossip-20230802152547-zfy8nr6.png "Alertmanager Gossip")​

## Gossip协议

Gossip是分布式系统中被广泛使用的协议，用于实现分布式节点之间的信息交换和状态同步。Gossip协议同步状态类似于流言或者病毒的传播，如下所示：

![gossip-protoctl](assets/gossip-protoctl-20230802152601-8tvt64s.png "Gossip分布式协议")​
...
![am-notifi-pipeline](assets/am-notifi-pipeline-20230802152617-urpzscj.png)
...
![am-gossip](assets/am-gossip-20230802152623-twbiktf.png "Gossip机制")​
...
![alertmanager-gossip-ha](assets/alertmanager-gossip-ha-20230802152644-kjsuwss.png "Alertmanager HA部署结构")​
...
![am-ha-status](assets/am-ha-status-20230802152700-re1u8ni.png "Alertmanager集群状态")​
...
![promethues-alertmanager-ha](assets/promethues-alertmanager-ha-20230802152720-q8t4si6.png "Promthues与Alertmanager HA部署结构")​
