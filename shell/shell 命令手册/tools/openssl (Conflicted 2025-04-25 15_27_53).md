# openssl (Conflicted 2025-04-25 15:27:53)

关于ssl证书相关文档请查看：

[证书签发的原理与流程](../../../网络与安全/数字证书/证书签发的原理与流程.md)

[数字证书,CA,CA证书,证书链](030%20信息安全/数字证书/数字证书,CA,CA证书,证书链%20.md)

生成证书的其他工具

[cfssl](../../../网络与安全/数字证书/ca制作工具/cfssl.md)    [easy-rsa3](../../../网络与安全/数字证书/ca制作工具/easy-rsa3.md)
...
首先，OpenSSL实现了ASN.1的证书和密钥相关标准，提供了对证书、公钥、私钥、证书请求以及CRL等数据对象的DER、PEM和BASE64的编解码功能。OpenSSL提供了产生各种公开密钥对和对称密钥的方法、函数和应用程序，同时提供了对公钥和私钥的DER编解码功能。并实现了私钥的PKCS​8的编解码功能。OpenSSL在标准中提供了对私钥的加密保护功能，使得密钥可以安全地进行存储和分发。

在此基础上，OpenSSL实现了对证书的X.509标准编解码、PKCS​7的编解码功能。并提供了一种文本数据库，支持证书的管理功能，包括证书密钥产生、请求产生、证书签发、吊销和验证等功能。
