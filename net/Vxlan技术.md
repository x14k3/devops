...
![img](network-asset-58f8a33c8503c97086742-20240729210303-r8ec5tz.png)
...
- VXLAN报文的封装格式为在原始二层数据帧外添加如下信息共计50字节
  ...
  ![image-20230725140852824](network-asset-image-20230725140852824-20240729210303-58akgaq.png)
...
![image-20230725140923257](network-asset-image-20230725140923257-20240729210303-tpocar7.png)
...
![img](network-asset-2c6f9e4adf07ac95c57a2-20240729210303-l14grm5.png)
...
![img](network-asset-6fb8b350b0d63ebe87be9-20240729210303-301wgot.png)
...
![img](network-asset-583b9c2427eb0ee3e4ec6-20240729210303-s12aial.png)
...
![img](network-asset-5c9f451defcef26ed01bd-20240729210303-w2mvfkv.png)

传统网络的流量进入VXLAN网络之后，通过二层子接口或者VLAN绑定的方式，与BD进行绑定，在BD中会指定VXLAN VNI，实现从传统的VLAN网络到VXLAN网络的映射。

### 5.Border与Edge

![img](network-asset-0411f022df49a7ff8f9cf-20240729210303-45gnwar.png)
...
![img](network-asset-d0cb8e1ee1c8406721f5e-20240729210303-olvdg9a.png)

- 二层（L2）网关：实现流量进入VXLAN网络，也可用于同一VXLAN网络内终端的同子网通信。

**三层网关**

![img](network-asset-a92252c478cbe55e6e786-20240729210303-mxob37l.png)
...
![img](network-asset-62bb1918f9418be00e38f-20240729210304-8kl66x2.png)
...
![img](network-asset-7f337e8551e962a9b891a-20240729210304-qncy7rq.png)
...
![img](network-asset-1b412d8183fe110f4ec3e-20240729210304-40es9rv.png)
...
![未命名文件](network-asset-未命名文件-20240729210304-l6og6ha.png)
