...
## <span id="20231110105237-1aq8824" style="display: none;"></span>2. [listener.ora 详解](Oracle%20配置详解/listener.ora%20详解.md)

文件位置：`$ORACLE_HOME/network/admin`​

## <span id="20231110105237-x105gp1" style="display: none;"></span>3. [tnsnames.ora 详解](Oracle%20配置详解/tnsnames.ora%20详解.md)
