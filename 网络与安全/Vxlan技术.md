...
![img|600](assets/network-asset-58f8a33c8503c97086742-20240729210303-r8ec5tz.png)
...
- VXLAN报文的封装格式为在原始二层数据帧外添加如下信息共计50字节
  ...
  ![image-20230725140852824|600](assets/network-asset-image-20230725140852824-20240729210303-58akgaq.png)
...
![image-20230725140923257|600](assets/network-asset-image-20230725140923257-20240729210303-tpocar7.png)
...
![img|600](assets/network-asset-2c6f9e4adf07ac95c57a2-20240729210303-l14grm5.png)
...
![img|600](assets/network-asset-6fb8b350b0d63ebe87be9-20240729210303-301wgot.png)
...
![img|600](assets/network-asset-583b9c2427eb0ee3e4ec6-20240729210303-s12aial.png)
...
![img|600](assets/network-asset-5c9f451defcef26ed01bd-20240729210303-w2mvfkv.png)

传统网络的流量进入VXLAN网络之后，通过二层子接口或者VLAN绑定的方式，与BD进行绑定，在BD中会指定VXLAN VNI，实现从传统的VLAN网络到VXLAN网络的映射。

### 5.Border与Edge

![img|600](assets/network-asset-0411f022df49a7ff8f9cf-20240729210303-45gnwar.png)
...
![img|600](assets/network-asset-d0cb8e1ee1c8406721f5e-20240729210303-olvdg9a.png)

- 二层（L2）网关：实现流量进入VXLAN网络，也可用于同一VXLAN网络内终端的同子网通信。

**三层网关**

![img|598](assets/network-asset-a92252c478cbe55e6e786-20240729210303-mxob37l.png)
...
![img|600](assets/network-asset-62bb1918f9418be00e38f-20240729210304-8kl66x2.png)
...
![未命名文件|600](assets/network-asset-未命名文件-20240729210304-l6og6ha.png)
