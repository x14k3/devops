...
![未命名文件.png](net-img-未命名文件-e05ba2db-20240801172514-izknyk8.png)
...
![clipboard.png](net-img-clipboard-df94e47f-20240801172514-50c91l9.png)

### 2.1.2 LVS的DR模式

LVS-DR：Direct  Routing，直接路由，LVS默认模式,应用最广泛,通过为请求报文重新封装一个MAC首部进行转发，源MAC是DIP所在的接口的MAC，目标MAC是某挑选出的RS的RIP所在接口的MAC地址；源IP/PORT，以及目标IP/PORT均保持不变  
​![未命名文件1.png](net-img-未命名文件_1-54e8b4dc-20240801172514-xeiym4n.png)
...
- 无需开启 ip\_forward
- RS可使用大多数OS系统  
  ​![clipboard.png](net-img-clipboard-5d861d57-20240801172514-lylyjzg.png)

### 2.1.3 LVS的TUN模式

转发方式：不修改请求报文的IP首部（源IP为CIP，目标IP为VIP），而在原IP报文之外再封装一个IP首部（源IP是DIP，目标IP是RIP），将报文发往挑选出的目标RS；RS直接响应给客户端（源IP是VIP，目标IP是CIP）  
​![clipboard.png](net-img-clipboard-46cbf473-20240801172514-r98t1iz.png)
...
![clipboard.png](net-img-clipboard-fc1f4ea5-20240801172514-i5r0rqo.png)
...
![clipboard.png](net-img-clipboard-a35593b2-20240801172514-ems7nup.png)
